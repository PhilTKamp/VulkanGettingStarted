...
private:
  ...
  static void framebufferResizeCallback(GLFWwindow *window, int width,
                                        int height) {
    auto app = static_cast<VulkanRaytracingApplication *>(
  ...
  void createInstance() {
    constexpr vk::ApplicationInfo appInfo{
        .pApplicationName = "Vulkan Tutorial Ray Tracing",
  ...
  void pickPhysicalDevice() {
    ...
    const auto devIter = std::ranges::find_if(devices, [&](auto const &device) {
      ...
      bool supportsRequiredFeatures =
          ...
          features.template get<vk::PhysicalDeviceRayQueryFeaturesKHR>()
              .rayQuery;
  ...
  void createGraphicsPipeline() {
    ...
    vk::PipelineLayoutCreateInfo pipelineLayoutInfo{.setLayoutCount = 2,
     ...
     *
     * This new struct replaces what previously was the render pass in the
     * pipeline creation. Note how this structure is now linked in .pNext below,
     * and .renderPass is not used.
     */
  ...
  void createUVBuffer() {
    ...
    createBuffer(bufferSize,
                 vk::BufferUsageFlagBits::eTransferDst |
                     vk::BufferUsageFlagBits::eStorageBuffer,
                 vk::MemoryPropertyFlagBits::eDeviceLocal, uvBuffer,
                 uvBufferMemory);
  ...
  void createInstanceLUTBuffer() {
    ...
    createBuffer(bufferSize,
                 vk::BufferUsageFlagBits::eTransferDst |
                     vk::BufferUsageFlagBits::eStorageBuffer,
                 vk::MemoryPropertyFlagBits::eDeviceLocal, instanceLUTBuffer,
                 instanceLUTBufferMemory);
  ...
  void createAccelerationStructures() {
    ...
    for (size_t i = 0; i < submeshes.size(); ++i) {
      ...
      // TASK07
      blasGeometry.flags = (submesh.alphaCut)
      ...
      createBuffer(blasBuildSizes.accelerationStructureSize,
                   vk::BufferUsageFlagBits::eAccelerationStructureStorageKHR |
                       ...
                       vk::BufferUsageFlagBits::
                           eAccelerationStructureBuildInputReadOnlyKHR,
                   vk::MemoryPropertyFlagBits::eDeviceLocal, blasBuffers[i],
                   blasMemories[i]);
      ...
      instanceLUTs.push_back(
          {static_cast<uint32_t>(submesh.materialID), submesh.indexOffset});
#endif // LAB_TASK_LEVEL >= LAB_TASK_INSTANCE_LUT
    }
    ...
    createBuffer(tlasBuildSizes.buildScratchSize,
                 vk::BufferUsageFlagBits::eStorageBuffer |
                     vk::BufferUsageFlagBits::eShaderDeviceAddress,
                 vk::MemoryPropertyFlagBits::eDeviceLocal, tlasScratchBuffer,
                 tlasScratchMemory);

    // Save the scratch buffer address in the build info structure
    vk::BufferDeviceAddressInfo scratchAddressInfo{.buffer =
                                                       *tlasScratchBuffer};
    vk::DeviceAddress scratchAddr =
        device.getBufferAddressKHR(scratchAddressInfo);
    ...
    createBuffer(tlasBuildSizes.accelerationStructureSize,
                 vk::BufferUsageFlagBits::eAccelerationStructureStorageKHR |
                     ...
                     vk::BufferUsageFlagBits::
                         eAccelerationStructureBuildInputReadOnlyKHR,
                 vk::MemoryPropertyFlagBits::eDeviceLocal, tlasBuffer,
                 tlasMemory);
  ...
  void createDescriptorSets() {
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
      ...
      vk::WriteDescriptorSet bufferWrite{.dstSet = globalDescriptorSets[i],
                                         .dstBinding = 0,
                                         .dstArrayElement = 0,
                                         .descriptorCount = 1,
                                         .descriptorType =
      ...
      // Indices SSBO
      vk::DescriptorBufferInfo indexBufferInfo{.buffer = indexBuffer,
                                               .offset = 0,
      ...
      // UVs SSBO
      vk::DescriptorBufferInfo uvBufferInfo{.buffer = uvBuffer,
                                            .offset = 0,
      ...
      std::array<vk::WriteDescriptorSet, 3> descriptorWrites{
          bufferWrite, indexBufferWrite, uvBufferWrite};
#endif
    ...
    vk::DescriptorSetVariableDescriptorCountAllocateInfo variableCountInfo{
        .descriptorSetCount = 1, .pDescriptorCounts = variableCounts.data()};
    ...
    vk::WriteDescriptorSet samplerWrite{.dstSet = materialDescriptorSets[0],
                                        .dstBinding = 0,
                                        .dstArrayElement = 0,
                                        .descriptorCount = 1,
                                        .descriptorType =
  ...
  void recordCommandBuffer(uint32_t imageIndex) {
    ...
    /* TASK01: Check the setup for dynamic rendering
     *
     * With dynamic rendering, we specify the image view and load/store
     * operations directly in the vk::RenderingAttachmentInfo structure. This
     * approach eliminates the need for explicit render pass and framebuffer
     * objects, simplifying the code and providing flexibility to change
    ...
    // The vk::RenderingInfo structure combines these attachments with other
    ...
    commandBuffers[currentFrame].bindDescriptorSets(
        ...
        *globalDescriptorSets[currentFrame], nullptr);
    commandBuffers[currentFrame].bindDescriptorSets(
    ...
    for (auto &sub : submeshes) {
      ...
      PushConstant pushConstant = {
          .materialIndex =
              sub.materialID < 0 ? 0u : static_cast<uint32_t>(sub.materialID),
#if LAB_TASK_LEVEL >= LAB_TASK_REFLECTIONS
          .reflective = sub.reflective
#endif // LAB_TASK_LEVEL >= LAB_TASK_REFLECTIONS
      };
      commandBuffers[currentFrame].pushConstants<PushConstant>(
          pipelineLayout, vk::ShaderStageFlagBits::eFragment, 0, pushConstant);

      commandBuffers[currentFrame].drawIndexed(sub.indexCount, 1,
                                               sub.indexOffset, 0, 0);
    }
  ...
  void updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.view =
        lookAt(eye, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
  ...
  void updateTopLevelAS(const glm::mat4 &model) {
    ...
    vk::raii::Buffer stagingBuffer({});
    vk::raii::DeviceMemory stagingBufferMemory({});
    createBuffer(instBufferSize, vk::BufferUsageFlagBits::eTransferSrc,
                 vk::MemoryPropertyFlagBits::eHostVisible |
                     vk::MemoryPropertyFlagBits::eHostCoherent,
                 stagingBuffer, stagingBufferMemory);
    ...
    cmd->pipelineBarrier(
        ...
        vk::PipelineStageFlagBits::
            eAccelerationStructureBuildKHR, // dstStageMask
        {},                                 // dependencyFlags
    ...
    cmd->pipelineBarrier(
        vk::PipelineStageFlagBits::
            eAccelerationStructureBuildKHR, // srcStageMask
        vk::PipelineStageFlagBits::eAccelerationStructureBuildKHR |
